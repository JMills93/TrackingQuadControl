...
(cl:defmethod cl:initialize-instance :after ((m <CurrentMission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CurrentMission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<CurrentMission> is deprecated: use roscopter-msg:CurrentMission instead.")))
...
(cl:defmethod wp_dist-val ((m <CurrentMission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:wp_dist-val is deprecated.  Use roscopter-msg:wp_dist instead.")
  (wp_dist m))

(cl:ensure-generic-function 'target_bearing-val :lambda-list '(m))
(cl:defmethod target_bearing-val ((m <CurrentMission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:target_bearing-val is deprecated.  Use roscopter-msg:target_bearing instead.")
  (target_bearing m))
