...
(cl:defmethod cl:initialize-instance :after ((m <Status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<Status> is deprecated: use roscopter-msg:Status instead.")))
...
(cl:defmethod battery_voltage-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:battery_voltage-val is deprecated.  Use roscopter-msg:battery_voltage instead.")
  (battery_voltage m))

(cl:ensure-generic-function 'battery_current-val :lambda-list '(m))
(cl:defmethod battery_current-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:battery_current-val is deprecated.  Use roscopter-msg:battery_current instead.")
  (battery_current m))

(cl:ensure-generic-function 'battery_remaining-val :lambda-list '(m))
(cl:defmethod battery_remaining-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:battery_remaining-val is deprecated.  Use roscopter-msg:battery_remaining instead.")
  (battery_remaining m))

(cl:ensure-generic-function 'sensors_enabled-val :lambda-list '(m))
(cl:defmethod sensors_enabled-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:sensors_enabled-val is deprecated.  Use roscopter-msg:sensors_enabled instead.")
  (sensors_enabled m))
