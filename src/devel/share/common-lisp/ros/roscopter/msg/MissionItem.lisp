...
(cl:defmethod cl:initialize-instance :after ((m <MissionItem>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionItem)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<MissionItem> is deprecated: use roscopter-msg:MissionItem instead.")))
...
(cl:defmethod mission_num-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:mission_num-val is deprecated.  Use roscopter-msg:mission_num instead.")
  (mission_num m))

(cl:ensure-generic-function 'isCurrent-val :lambda-list '(m))
(cl:defmethod isCurrent-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:isCurrent-val is deprecated.  Use roscopter-msg:isCurrent instead.")
  (isCurrent m))

(cl:ensure-generic-function 'isAutoContinue-val :lambda-list '(m))
(cl:defmethod isAutoContinue-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:isAutoContinue-val is deprecated.  Use roscopter-msg:isAutoContinue instead.")
  (isAutoContinue m))

(cl:ensure-generic-function 'posAcc-val :lambda-list '(m))
(cl:defmethod posAcc-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:posAcc-val is deprecated.  Use roscopter-msg:posAcc instead.")
  (posAcc m))

(cl:ensure-generic-function 'holdTime-val :lambda-list '(m))
(cl:defmethod holdTime-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:holdTime-val is deprecated.  Use roscopter-msg:holdTime instead.")
  (holdTime m))

(cl:ensure-generic-function 'loiterRadius-val :lambda-list '(m))
(cl:defmethod loiterRadius-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:loiterRadius-val is deprecated.  Use roscopter-msg:loiterRadius instead.")
  (loiterRadius m))

(cl:ensure-generic-function 'yawFrom-val :lambda-list '(m))
(cl:defmethod yawFrom-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:yawFrom-val is deprecated.  Use roscopter-msg:yawFrom instead.")
  (yawFrom m))

(cl:ensure-generic-function 'x_lat-val :lambda-list '(m))
(cl:defmethod x_lat-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:x_lat-val is deprecated.  Use roscopter-msg:x_lat instead.")
  (x_lat m))

(cl:ensure-generic-function 'y_long-val :lambda-list '(m))
(cl:defmethod y_long-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:y_long-val is deprecated.  Use roscopter-msg:y_long instead.")
  (y_long m))

(cl:ensure-generic-function 'z_alt-val :lambda-list '(m))
(cl:defmethod z_alt-val ((m <MissionItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:z_alt-val is deprecated.  Use roscopter-msg:z_alt instead.")
  (z_alt m))
