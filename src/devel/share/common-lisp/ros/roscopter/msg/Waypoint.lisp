...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<Waypoint> is deprecated: use roscopter-msg:Waypoint instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:latitude-val is deprecated.  Use roscopter-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:longitude-val is deprecated.  Use roscopter-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:altitude-val is deprecated.  Use roscopter-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'pos_acc-val :lambda-list '(m))
(cl:defmethod pos_acc-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:pos_acc-val is deprecated.  Use roscopter-msg:pos_acc instead.")
  (pos_acc m))

(cl:ensure-generic-function 'speed_to-val :lambda-list '(m))
(cl:defmethod speed_to-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:speed_to-val is deprecated.  Use roscopter-msg:speed_to instead.")
  (speed_to m))

(cl:ensure-generic-function 'hold_time-val :lambda-list '(m))
(cl:defmethod hold_time-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:hold_time-val is deprecated.  Use roscopter-msg:hold_time instead.")
  (hold_time m))

(cl:ensure-generic-function 'yaw_from-val :lambda-list '(m))
(cl:defmethod yaw_from-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:yaw_from-val is deprecated.  Use roscopter-msg:yaw_from instead.")
  (yaw_from m))

(cl:ensure-generic-function 'pan_angle-val :lambda-list '(m))
(cl:defmethod pan_angle-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:pan_angle-val is deprecated.  Use roscopter-msg:pan_angle instead.")
  (pan_angle m))

(cl:ensure-generic-function 'tilt_angle-val :lambda-list '(m))
(cl:defmethod tilt_angle-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:tilt_angle-val is deprecated.  Use roscopter-msg:tilt_angle instead.")
  (tilt_angle m))

(cl:ensure-generic-function 'waypoint_type-val :lambda-list '(m))
(cl:defmethod waypoint_type-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:waypoint_type-val is deprecated.  Use roscopter-msg:waypoint_type instead.")
  (waypoint_type m))
