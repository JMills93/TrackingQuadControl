...
(cl:defmethod cl:initialize-instance :after ((m <FilteredPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FilteredPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<FilteredPosition> is deprecated: use roscopter-msg:FilteredPosition instead.")))
...
(cl:defmethod relative_altitude-val ((m <FilteredPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:relative_altitude-val is deprecated.  Use roscopter-msg:relative_altitude instead.")
  (relative_altitude m))

(cl:ensure-generic-function 'ground_x_speed-val :lambda-list '(m))
(cl:defmethod ground_x_speed-val ((m <FilteredPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:ground_x_speed-val is deprecated.  Use roscopter-msg:ground_x_speed instead.")
  (ground_x_speed m))

(cl:ensure-generic-function 'ground_y_speed-val :lambda-list '(m))
(cl:defmethod ground_y_speed-val ((m <FilteredPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:ground_y_speed-val is deprecated.  Use roscopter-msg:ground_y_speed instead.")
  (ground_y_speed m))

(cl:ensure-generic-function 'ground_z_speed-val :lambda-list '(m))
(cl:defmethod ground_z_speed-val ((m <FilteredPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:ground_z_speed-val is deprecated.  Use roscopter-msg:ground_z_speed instead.")
  (ground_z_speed m))
