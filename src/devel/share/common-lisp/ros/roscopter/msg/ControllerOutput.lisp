...
(cl:defmethod cl:initialize-instance :after ((m <ControllerOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControllerOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<ControllerOutput> is deprecated: use roscopter-msg:ControllerOutput instead.")))

(cl:ensure-generic-function 'nav_roll-val :lambda-list '(m))
(cl:defmethod nav_roll-val ((m <ControllerOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:nav_roll-val is deprecated.  Use roscopter-msg:nav_roll instead.")
  (nav_roll m))

(cl:ensure-generic-function 'nav_pitch-val :lambda-list '(m))
(cl:defmethod nav_pitch-val ((m <ControllerOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:nav_pitch-val is deprecated.  Use roscopter-msg:nav_pitch instead.")
  (nav_pitch m))

(cl:ensure-generic-function 'nav_bearing-val :lambda-list '(m))
(cl:defmethod nav_bearing-val ((m <ControllerOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:nav_bearing-val is deprecated.  Use roscopter-msg:nav_bearing instead.")
  (nav_bearing m))

(cl:ensure-generic-function 'alt_error-val :lambda-list '(m))
(cl:defmethod alt_error-val ((m <ControllerOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:alt_error-val is deprecated.  Use roscopter-msg:alt_error instead.")
  (alt_error m))

(cl:ensure-generic-function 'air_spd_error-val :lambda-list '(m))
(cl:defmethod air_spd_error-val ((m <ControllerOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:air_spd_error-val is deprecated.  Use roscopter-msg:air_spd_error instead.")
  (air_spd_error m))

(cl:ensure-generic-function 'xtrack_error-val :lambda-list '(m))
(cl:defmethod xtrack_error-val ((m <ControllerOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:xtrack_error-val is deprecated.  Use roscopter-msg:xtrack_error instead.")
  (xtrack_error m))
